...
External reference baseline: `a13a31a083746d0c66e8cba17b84fea82c8b8096`
...
## External reference system adaptations

The external reference informed these decisions:
...
The external reference system remains a reference, not a runtime dependency. Hanoon keeps BB as the session, provider, environment, and worktree authority.
