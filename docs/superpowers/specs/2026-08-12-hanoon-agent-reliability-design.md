...
All numeric bounds in this document are product policy, not limits derived from Kubernetes, AWS, GitHub, SQLite, or another standard. Changing one requires an explicit policy and test change.
