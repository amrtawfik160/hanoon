...
export class LunaControllerService {
  ...
  private async reconcileEvidence(
    ...
    try {
      ...
      // Not fatal. The cap has refused a write, which costs this turn its
      // claims and nothing else; retiring it here is what used to cost the
      // owner the question as well.
