...
export function buildWorkOrder(job: Job, policy: ProjectPolicy): HandoffArtifact {
  const text = [
    ...
    "",
    "## Outcome",
    "Deliver exactly what the original request asks for, and nothing beyond it. Where the request describes a defect, reproduce it first and keep the fix narrow. Where the request describes new or changed behavior, build what it specifies and leave adjacent systems alone.",
    "",
    "## Required workflow",
    "1. Inspect the existing implementation and confirm the current behavior the request refers to.",
    "2. Implement what the request specifies, with tests covering the behavior it describes.",
    ...
    "5. Do not deploy, merge, or make changes the request did not ask for.",
    "",
    "## Validation policy",
